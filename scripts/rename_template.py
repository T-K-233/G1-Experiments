...
It renames all the occurrences of g1_exp_variable_frequency (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    old_name = "g1_exp_variable_frequency"
    new_name = sys.argv[1]
    ...
    if proceed.lower() == "y":
        # rename the g1_exp_variable_frequency folder
        os.rename(
            os.path.join(root_dir_path, "exts", "g1_exp_variable_frequency", "g1_exp_variable_frequency"),
            os.path.join(root_dir_path, "exts", "g1_exp_variable_frequency", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "g1_exp_variable_frequency"), os.path.join(root_dir_path, "exts", new_name))

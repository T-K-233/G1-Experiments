...
def some_public_function(x: int):
    print("[g1_exp_variable_frequency] some_public_function was called with x: ", x)
    return x**x
...
class ExampleExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[g1_exp_variable_frequency] startup")
    ...
    def on_shutdown(self):
        print("[g1_exp_variable_frequency] shutdown")
